...
<head>
	...
	<script>
      $(document).ready(function(){
        $('#cursosAlumno').DataTable({

        });
      });
    </script>
	<title>Añadir curso alumno</title>
</head>
	...
	<div class="container fluid">
		<div class="row mb-3 mt-3">
			<div class="col-md-4">
				...
				<a class="btn btn-outline-success" href="añadirCurso.php" role="button">Añadir</a>
				<br><br>
			...
			<div class="col-md-8">
				<?php
					include ("resultadoCursosAlumno.php");
				?>
			</div>
		</div>
	</div>
